...
classdef Drone < handle
    ...
    methods
        ...
        function update(obj)
            ...
            % Drone hovers with equal inputs matching gravity and drag
            if obj.time<2
                obj.inputs = obj.equ_inputs;
                % Drone rises as inputs are increased
            elseif obj.time>=2 && obj.time<4
                obj.inputs = 1.2 .* obj.equ_inputs;
                % Drone spins and falls as gamma_4 =0
            ...
            % [obj.pos; obj.pos_dot; obj.th; obj.omega]

            [obj.Ad, obj.Bd] = disc_linearisation(obj);
            obj.delta_x = obj.Ad * (obj.delta_x)...
                +obj.Bd * (obj.inputs- obj.pre_inputs);
            obj.state = obj.state + obj.delta_x;

            % update variables
            obj.pre_inputs = obj.inputs;
            obj.pos = obj.state (1:3);
            obj.pos_dot = obj.state (4:6);
            obj.th = obj.state (7:9);
            obj.omega = obj.state (10:12);
            obj.R = eul2rotm(obj.th');
